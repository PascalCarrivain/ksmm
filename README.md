...
batch_size = 25088 # any multiple of 16 is fine with the kernel, but most tuning effort has been spent on 25'088= 196 (ctx length) * 128 (batch-size) = effective ViT batch-size
