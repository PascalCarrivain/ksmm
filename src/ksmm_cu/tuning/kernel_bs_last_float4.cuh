...
#ifndef KERNEL_BS_LAST_FLOAT4
#define KERNEL_BS_LAST_FLOAT4

#include "template_kernels_float4.cuh"

void best_kernel_bs_last_float4(float *input, float *values, float *output, int batch_size, int a, int b, int c, int d, dim3 &blockGrid, dim3 &threadsPerBlock){
	while (1) {
		threadsPerBlock.y = 1;
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 1) {
			...
			blockGrid.x = 3;
			blockGrid.y = 392;
			kernel_bs_last_float4<16, 16, 64, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 3) {
			...
			blockGrid.x = 9;
			blockGrid.y = 784;
			kernel_bs_last_float4<16, 16, 32, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 12) {
			...
			blockGrid.x = 36;
			blockGrid.y = 196;
			kernel_bs_last_float4<16, 16, 128, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 48) {
			...
			blockGrid.x = 144;
			blockGrid.y = 392;
			kernel_bs_last_float4<16, 16, 64, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 64) {
			...
			blockGrid.x = 128;
			blockGrid.y = 392;
			kernel_bs_last_float4<24, 24, 64, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 96) {
			...
			blockGrid.x = 96;
			blockGrid.y = 392;
			kernel_bs_last_float4<48, 24, 64, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 48 && c == 192 && d == 16) {
			...
			blockGrid.x = 16;
			blockGrid.y = 392;
			kernel_bs_last_float4<48, 24, 64, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 1) {
			...
			blockGrid.x = 1;
			blockGrid.y = 392;
			kernel_bs_last_float4<64, 16, 64, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 2) {
			...
			blockGrid.x = 2;
			blockGrid.y = 784;
			kernel_bs_last_float4<64, 16, 32, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 3) {
			...
			blockGrid.x = 3;
			blockGrid.y = 392;
			kernel_bs_last_float4<64, 16, 64, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 4) {
			...
			blockGrid.x = 4;
			blockGrid.y = 784;
			kernel_bs_last_float4<64, 32, 32, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 24) {
			...
			blockGrid.x = 24;
			blockGrid.y = 784;
			kernel_bs_last_float4<64, 32, 32, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 48) {
			...
			blockGrid.x = 48;
			blockGrid.y = 784;
			kernel_bs_last_float4<64, 16, 32, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 64) {
			...
			blockGrid.x = 64;
			blockGrid.y = 392;
			kernel_bs_last_float4<64, 16, 64, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 256 && d == 1) {
			...
			blockGrid.x = 1;
			blockGrid.y = 392;
			kernel_bs_last_float4<64, 16, 64, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 256 && d == 5) {
			...
			blockGrid.x = 5;
			blockGrid.y = 784;
			kernel_bs_last_float4<64, 16, 32, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 1) {
			...
			blockGrid.x = 3;
			blockGrid.y = 784;
			kernel_bs_last_float4<32, 32, 32, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 2) {
			...
			blockGrid.x = 6;
			blockGrid.y = 392;
			kernel_bs_last_float4<32, 16, 64, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 3) {
			...
			blockGrid.x = 9;
			blockGrid.y = 784;
			kernel_bs_last_float4<32, 16, 32, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 5) {
			...
			blockGrid.x = 15;
			blockGrid.y = 392;
			kernel_bs_last_float4<32, 32, 64, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 12) {
			...
			blockGrid.x = 36;
			blockGrid.y = 196;
			kernel_bs_last_float4<32, 16, 128, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 32) {
			...
			blockGrid.x = 96;
			blockGrid.y = 196;
			kernel_bs_last_float4<32, 16, 128, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 48) {
			...
			blockGrid.x = 144;
			blockGrid.y = 392;
			kernel_bs_last_float4<32, 16, 64, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 384 && d == 1) {
			...
			blockGrid.x = 3;
			blockGrid.y = 392;
			kernel_bs_last_float4<32, 16, 64, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 384 && d == 3) {
			...
			blockGrid.x = 9;
			blockGrid.y = 784;
			kernel_bs_last_float4<32, 16, 32, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 384 && d == 8) {
			...
			blockGrid.x = 24;
			blockGrid.y = 784;
			kernel_bs_last_float4<32, 32, 32, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 128 && c == 128 && d == 4) {
			...
			blockGrid.x = 8;
			blockGrid.y = 784;
			kernel_bs_last_float4<64, 32, 32, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 128 && c == 128 && d == 6) {
			...
			blockGrid.x = 12;
			blockGrid.y = 784;
			kernel_bs_last_float4<64, 16, 32, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 128 && c == 128 && d == 24) {
			...
			blockGrid.x = 48;
			blockGrid.y = 784;
			kernel_bs_last_float4<64, 32, 32, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 192 && c == 48 && d == 1) {
			...
			blockGrid.x = 8;
			blockGrid.y = 784;
			kernel_bs_last_float4<24, 24, 32, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 384 && c == 96 && d == 24) {
			...
			blockGrid.x = 288;
			blockGrid.y = 392;
			kernel_bs_last_float4<32, 16, 64, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 2 && b == 48 && c == 48 && d == 4) {
			...
			blockGrid.x = 24;
			blockGrid.y = 392;
			kernel_bs_last_float4<16, 16, 64, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 2 && b == 48 && c == 192 && d == 4) {
			...
			blockGrid.x = 24;
			blockGrid.y = 196;
			kernel_bs_last_float4<16, 16, 128, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 4 && b == 192 && c == 48 && d == 16) {
			...
			blockGrid.x = 512;
			blockGrid.y = 784;
			kernel_bs_last_float4<24, 24, 32, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 6 && b == 96 && c == 384 && d == 1) {
			...
			blockGrid.x = 18;
			blockGrid.y = 196;
			kernel_bs_last_float4<32, 16, 128, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 8 && b == 96 && c == 384 && d == 1) {
			...
			blockGrid.x = 24;
			blockGrid.y = 392;
			kernel_bs_last_float4<32, 32, 64, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 64 && b == 48 && c == 48 && d == 1) {
			...
			blockGrid.x = 64;
			blockGrid.y = 392;
			kernel_bs_last_float4<48, 24, 64, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
