...
#ifndef KERNEL_BS_LAST_HALF2
#define KERNEL_BS_LAST_HALF2

#include "template_kernels_half2.cuh"

void best_kernel_bs_last_half2(half *input, half *values, half *output, int batch_size, int a, int b, int c, int d, dim3 &blockGrid, dim3 &threadsPerBlock){
	while (1) {
		threadsPerBlock.y = 1;
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 1) {
			...
			blockGrid.x = 3;
			blockGrid.y = 196;
			kernel_bs_last_half2<16, 16, 128, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 4) {
			...
			blockGrid.x = 12;
			blockGrid.y = 392;
			kernel_bs_last_half2<16, 16, 64, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 6) {
			...
			blockGrid.x = 18;
			blockGrid.y = 196;
			kernel_bs_last_half2<16, 16, 128, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 8) {
			...
			blockGrid.x = 24;
			blockGrid.y = 392;
			kernel_bs_last_half2<16, 16, 64, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 48 && c == 48 && d == 128) {
			...
			blockGrid.x = 384;
			blockGrid.y = 392;
			kernel_bs_last_half2<16, 4, 64, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 48 && c == 192 && d == 1) {
			...
			blockGrid.x = 3;
			blockGrid.y = 784;
			kernel_bs_last_half2<16, 16, 32, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 1) {
			...
			blockGrid.x = 1;
			blockGrid.y = 392;
			kernel_bs_last_half2<64, 16, 64, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 2) {
			...
			blockGrid.x = 2;
			blockGrid.y = 784;
			kernel_bs_last_half2<64, 16, 32, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 5) {
			...
			blockGrid.x = 5;
			blockGrid.y = 392;
			kernel_bs_last_half2<64, 16, 64, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 32) {
			...
			blockGrid.x = 32;
			blockGrid.y = 196;
			kernel_bs_last_half2<64, 16, 128, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 64 && d == 64) {
			...
			blockGrid.x = 64;
			blockGrid.y = 196;
			kernel_bs_last_half2<64, 16, 128, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 256 && d == 1) {
			...
			blockGrid.x = 1;
			blockGrid.y = 784;
			kernel_bs_last_half2<64, 16, 32, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 64 && c == 256 && d == 32) {
			...
			blockGrid.x = 32;
			blockGrid.y = 392;
			kernel_bs_last_half2<64, 16, 64, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 1) {
			...
			blockGrid.x = 3;
			blockGrid.y = 196;
			kernel_bs_last_half2<32, 16, 128, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 2) {
			...
			blockGrid.x = 6;
			blockGrid.y = 392;
			kernel_bs_last_half2<32, 16, 64, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 6) {
			...
			blockGrid.x = 18;
			blockGrid.y = 392;
			kernel_bs_last_half2<32, 16, 64, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 96 && d == 24) {
			...
			blockGrid.x = 72;
			blockGrid.y = 196;
			kernel_bs_last_half2<32, 16, 128, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 384 && d == 4) {
			...
			blockGrid.x = 12;
			blockGrid.y = 196;
			kernel_bs_last_half2<32, 16, 128, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 96 && c == 384 && d == 8) {
			...
			blockGrid.x = 24;
			blockGrid.y = 392;
			kernel_bs_last_half2<32, 16, 64, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 128 && c == 512 && d == 2) {
			...
			blockGrid.x = 4;
			blockGrid.y = 392;
			kernel_bs_last_half2<64, 16, 64, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 128 && c == 512 && d == 4) {
			...
			blockGrid.x = 8;
			blockGrid.y = 196;
			kernel_bs_last_half2<64, 16, 128, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 256 && c == 256 && d == 16) {
			...
			blockGrid.x = 64;
			blockGrid.y = 784;
			kernel_bs_last_half2<64, 16, 32, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 256 && c == 1024 && d == 5) {
			...
			blockGrid.x = 20;
			blockGrid.y = 784;
			kernel_bs_last_half2<64, 16, 32, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 1 && b == 384 && c == 96 && d == 48) {
			...
			blockGrid.x = 576;
			blockGrid.y = 784;
			kernel_bs_last_half2<32, 16, 32, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 2 && b == 48 && c == 48 && d == 4) {
			...
			blockGrid.x = 24;
			blockGrid.y = 392;
			kernel_bs_last_half2<16, 16, 64, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		if (batch_size == 25088 && a == 2 && b == 48 && c == 48 && d == 16) {
			...
			blockGrid.x = 96;
			blockGrid.y = 196;
			kernel_bs_last_half2<16, 16, 128, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 2 && b == 48 && c == 192 && d == 16) {
			...
			blockGrid.x = 96;
			blockGrid.y = 392;
			kernel_bs_last_half2<16, 4, 64, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 2 && b == 96 && c == 384 && d == 16) {
			...
			blockGrid.x = 96;
			blockGrid.y = 392;
			kernel_bs_last_half2<32, 6, 64, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 2 && b == 384 && c == 96 && d == 16) {
			...
			blockGrid.x = 384;
			blockGrid.y = 784;
			kernel_bs_last_half2<32, 6, 32, 8, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 3 && b == 384 && c == 384 && d == 16) {
			...
			blockGrid.x = 288;
			blockGrid.y = 392;
			kernel_bs_last_half2<64, 6, 64, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 3 && b == 512 && c == 512 && d == 4) {
			...
			blockGrid.x = 96;
			blockGrid.y = 196;
			kernel_bs_last_half2<64, 16, 128, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 4 && b == 96 && c == 384 && d == 4) {
			...
			blockGrid.x = 48;
			blockGrid.y = 784;
			kernel_bs_last_half2<32, 6, 32, 4, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 4 && b == 768 && c == 192 && d == 4) {
			...
			blockGrid.x = 192;
			blockGrid.y = 784;
			kernel_bs_last_half2<64, 6, 32, 8, 8><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 24 && b == 96 && c == 384 && d == 1) {
			...
			blockGrid.x = 72;
			blockGrid.y = 392;
			kernel_bs_last_half2<32, 16, 64, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
		...
		if (batch_size == 25088 && a == 128 && b == 192 && c == 48 && d == 1) {
			...
			blockGrid.x = 1536;
			blockGrid.y = 784;
			kernel_bs_last_half2<16, 4, 32, 4, 4><<<blockGrid, threadsPerBlock>>>(input, values, 25088, output, a, b, c, d);
			break;
		}
